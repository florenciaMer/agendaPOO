...
include_once('../../Controllers/facturacion/listado_de_no_facturadas.php');
            ...
            <div class="card col-md-10">
             <div class="card-body">
                <div class="d-flex justify-content-between m-2">
                    <h3>No Facturadas </h3>
                    <a href="create_no_facturadas.php" class="btn btn-primary">Ver por paciente</a>
                </div>
    ...
    <tbody>
        ...
        foreach ($facturacion_datos as $facturacion) {
            ...
            if ($facturacion['facturado'] == 1) {
              ...
              echo '<a href="../../Controllers/facturar/marcar_facturada_por_paciente.php?id_facturacion=' . $facturacion['id_reserva'] . '&vieneDeNofacturacionIndex=1" >Facturar</a>';
  }
            echo '</td>';
